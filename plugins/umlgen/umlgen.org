...
** Построение диаграммы классов
   ...
   Достаточно лишь отслеживать нахождение в текущем
   неймспейсе(модуле). При построчном чтении для этого достаточно
   отслеживать отступы у каждого ключевого слова, задающего
   пространства имен. 
